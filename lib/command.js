...
void function () {
  var $0, build, cache$, CJSEverywhere, escodegen, escodegenCompactFormat, escodegenDefaultFormat, fs, Jedediah, optionParser, options, originalEntryPoint, path, positionalArgs, processed, root, startWatching, watching;
  fs = require('fs');
  path = require('path');
  ...
  if (options.watch) {
    watching = [];
    (startWatching = function (processed) {
