...
void function () {
  var $0, _, aliasPair, btoa, build, cache$, cache$1, CJSEverywhere, dep, deps, escodegen, escodegenCompactFormat, escodegenDefaultFormat, fs, Jedediah, match, optionParser, options, originalEntryPoint, path, positionalArgs, root, startBuild, stdinput;
  fs = require('fs');
  path = require('path');
