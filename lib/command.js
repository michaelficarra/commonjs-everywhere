...
void function () {
  var $0, _, build, cache$, CJSEverywhere, dep, deps, escodegen, escodegenCompactFormat, escodegenDefaultFormat, fs, Jedediah, optionParser, options, originalEntryPoint, path, positionalArgs, root, startBuild, stdinput;
  fs = require('fs');
  path = require('path');
  ...
  build = function (entryPoint, processed) {
    var bundled, cache$1, cache$2, canonicalName, code, e, esmangle, file, fileContents, filename, map, newDeps, sourceMappingUrl;
    if (null == processed)
      processed = {};
    try {
