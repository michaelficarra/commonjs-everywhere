(function() {
  var $0, CJSEverywhere, Jedediah, build, destination, escodegen, escodegenCompactFormat, escodegenDefaultFormat, fs, optionParser, options, originalEntryPoint, path, positionalArgs, root, startBuild, stdinput, _ref,
  ...
  destination = options.output ? path.dirname(options.output) : process.cwd();
