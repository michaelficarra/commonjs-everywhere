...
void function () {
  var bundle, CoffeeScript, CORE_DIR, esprima, estraverse, fs, isCore, path, PRELUDE, relativeResolve, resolve, resolvePath, wrapFile;
  path = require('path');
  fs = require('fs');
  ...
  bundle = function (processed, entryPoint, options) {
    var ast, canonicalName, exportExpression, lhsExpression, outputProgram, requireEntryPoint;
