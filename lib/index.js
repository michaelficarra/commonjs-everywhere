...
void function () {
  var async, async_if, badRequireError, bundle, canonicalise, CJS_DIR, cjsify, cjsifySync, CoffeeScript, CORE_MODULES, esprima, estraverse, fs, isCore, mod, NODE_CORE_MODULES, path, PRELUDE, PRELUDE_NODE, relativeResolve, relativeResolveSync, resolve, resolvePath, resolvePathSync, traverseDependencies, traverseDependenciesSync, wrapFile;
  path = require('path');
  fs = require('fs');
  ...
  bundle = function (processed, entryPoint, root, options) {
    ...
    prelude = (null != options.node ? options.node : true) ? '' + PRELUDE_NODE + '\n' + PRELUDE : PRELUDE;
