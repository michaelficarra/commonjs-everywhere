...
void function () {
  var async, async_if, badRequireError, bundle, canonicalise, cjsify, cjsifySync, CoffeeScript, CORE_DIR, esprima, estraverse, fs, isCore, path, PRELUDE, PRELUDE_NODE, relativeResolve, relativeResolveSync, resolve, resolvePath, resolvePathSync, traverseDependencies, traverseDependenciesSync, wrapFile;
  path = require('path');
  fs = require('fs');
